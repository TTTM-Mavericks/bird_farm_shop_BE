...
import com.tttm.birdfarmshop.Utils.Payment;
...
public class OrderPayOSController {
    ...
    public OrderPayOSController(PayOSService orderService) {
        super();
    ...
    public ObjectNode createPaymentLink(@RequestBody Payment payment) {
        ...
        try {
            ...
            orderService.CreateOrder(
                    new PayOS(orderCode, objectMapper.writeValueAsString(items), body.getAmount(),
    ...
    public ObjectNode getOrderById(@PathVariable("orderId") int orderId) {
        ...
        try {
            PayOS order = orderService.getOrder(orderId);
